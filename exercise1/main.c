...
void test_func(char *pin, int hash_real, int clearance_real, int lucas_real);
...
//main
int main (){
    int hash_res, clearance_res, final_res;
    char pin[] = "Ab45j";
    ...
    // Time for testing
    test_func(pin, hash_res, clearance_res, final_res);
