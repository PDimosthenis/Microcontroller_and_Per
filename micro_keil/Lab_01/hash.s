.global access_hash
    ...
    end_loop:
        ADD R0, R12, R1        @ Final Hash = Sum (R12) + Length (R1)
        ...
        @ +++ EPILOGUE +++
        POP {R4, R5}           @ Pop registers from stack
